        ...
        <div class="w-full sm:w-2/3 p-4 sm:p-6 flex flex-col justify-between">
            ...
            <div>
                ...
                <div class="space-y-3 sm:space-y-4 text-text text-sm sm:text-base">
                    ...
                    <p>
                        <span class="font-extrabold">{{ __('animalCard.breed') }} </span>
                        {{ $breed }}
                    </p>
                    <p>
                        <span class="font-extrabold">{{ __('animalCard.gender') }} </span>
                        {{ $gender ? 'Mâle' : 'Femelle' }}
                    </p>

                    <p>
                        <span class="font-extrabold">{{ __('animalCard.age') }} </span>
                        {{ $birthDate }}
                    </p>

                    <p class="leading-relaxed">
                        <span class="font-extrabold">{{ __('animalCard.description') }}</span>
                        {{ $description }}
                    </p>
