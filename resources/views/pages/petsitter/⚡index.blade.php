...
<div>
    <section class=" m-5 mx-5 lg:mt-20">
        <div class="flex flex-row gap-8 relative">
            ...
            <div class="border-5 border-element rounded-lg py-10">
                <h1 class=" text-text text-2xl text-center font-bold mb-4 lg:text-3xl">{{ __('petsitter.title') }}</h1>
    ...
    <section
        ...
        <img src="{{ asset('svg/ill_6.svg') }}"
             ...
             class="hidden lg:block absolute bottom-5 left-0 xl:left-10
     w-30 sm:w-40 md:w-56 lg:w-72 xl:w-80
     -translate-x-1/4 translate-y-1/4">

        <img src="{{ asset('svg/ill_7.svg') }}"
             alt="illustration d'une femme en train de promener un chien brun"
             class="hidden lg:block absolute bottom-5 right-0 xl:right-10
     w-30 sm:w-40 md:w-56 lg:w-72 xl:w-80
     translate-x-1/4 translate-y-1/4">
    </section>
</div>
